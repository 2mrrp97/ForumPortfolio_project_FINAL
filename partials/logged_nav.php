    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsethis">
            ...
            <form class="d-flex" action="./logout.php">
                <h5 style = "margin-right : 8px;" class = "mt-2 ">Welcome! <a id = "userHandle" href="./users.php?uid=<?php echo $_SESSION['username'];?>" style = "text-decoration : none;" ><?php echo $_SESSION['username']; ?></a>
                </h5>
