...
let mssg = "Welcome! Here I have show cased all of my Projects and technologies i have worked on. I hope i can demostrate my technology exptertise using this portfolio! ";
...
function filter_and_show(arr, type) {
    ...
    arr.filter((obj) => {
        ...
        s += `<div class="mycard my-2" data-id="small" style = "position : relative ;">
